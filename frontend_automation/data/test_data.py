...
# Test data for Browser Windows
BROWSER_WINDOWS_DATA = {
    "New Tab": {
        "button_id": "tabButton",
        "expected_message": "This is a sample page"
    },
    "New Window": {
        "button_id": "windowButton",
        "expected_message": "This is a sample page"
    },
    "New Window Message": {
        "button_id": "messageWindowButton",
        "expected_message": "Knowledge increases by sharing but not by saving"
    }
}
